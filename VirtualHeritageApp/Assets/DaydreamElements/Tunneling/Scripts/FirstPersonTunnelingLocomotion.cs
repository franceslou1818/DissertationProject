...
namespace DaydreamElements.Tunneling {
  ...
  public class FirstPersonTunnelingLocomotion : MonoBehaviour {
	...
	/*
	 * `GvrControllerInput.TouchDown' is obsolete: 
	`Replaced by GvrControllerInputDevice.GetButtonDown(GvrControllerButton.TouchPadTouch).' 
	
	`GvrControllerInput.TouchPos' is obsolete: 
	`Obsolete. Migrate to the center-relative GvrControllerInputDevice.TouchPos.'
